...
#define BRAKE_ACTIVE 2400            // Threshold for brake pedal active (set to be doable by hand)
...
#define START_ACCELERATOR_PEDAL_1 650  // Position to start acceleration
#define END_ACCELERATOR_PEDAL_1 3500   // Position to max out acceleration
...
#define START_ACCELERATOR_PEDAL_2 450  // Position to start acceleration
#define END_ACCELERATOR_PEDAL_2 2500    // Position to max out acceleration
